...
2. <a name="Protocol"></a> **Protocol**
	...
	- Using 10x objective, count cells in one side of the hemocytometer. Each grid is divided into nine large squares- keep track of how many you count. Count until you reach 300 total cells (or count all squares), then calculate average # of cells per square.
	- Repeat with other side of hemocytometer.
	- Clean cytometer as before with DI water. Clean glass pipet with a tube of DI water.
	- Repeat above steps twice more for 6 total counts. Make sure average # of cells/square is consistent (calculate std dev and coefficient of variation- should be less than 10%).
